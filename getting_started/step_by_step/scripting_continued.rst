...
Godot has a "Script Class" feature to register individual scripts with the Editor. Users name the script and give it an optional icon.
These name-script pairings are then supplied to scripting languages in Godot.
The named scripts that derive Node or Resource will show up in their respective creation dialogs in the Editor.
